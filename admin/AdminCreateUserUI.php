					...
					<form action='' method='post'>
						<div class = "FormHolder">
							<div class = "FormFieldHolder">
								<div class = "FieldHeader">User ID</div>
								...
								<div class = "FieldHeader">Role</div>
								...
								<button type="submit" class = "LoginButton" name="create">Create</button>
								<?php 
									include "AdminCreateUserCtr.php";
									...
									if(isset($_POST['create']))
									{
										...
										$admin = new AdminCreateUserCtr();

										$output = $admin->validateCreate($uid, $pwd, $role);
