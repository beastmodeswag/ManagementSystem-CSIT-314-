...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type ="text" name ="id" placeholder= "Username" class = "UsernameField" method="post"></td>
        </tr>
         <tr>
			<td></td>
            <td><label> Password: </label></td>
            <!--- <td><input type="password" name="pwd" id="password-field" class="login-form-field" placeholder="Password" disabled></td> --->
            <td><input type ="password" name ="pwd" placeholder= "Password" class = "PasswordField" method="post"></td> 
        </tr>
        <tr>
			<td></td><td></td>
            <td><button type="submit" value="Login" name="submit"> Log in</button></td>
        </tr>
	</form>
   </table>
